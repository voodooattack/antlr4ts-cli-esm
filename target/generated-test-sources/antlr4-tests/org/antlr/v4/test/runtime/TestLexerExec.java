...
public class TestLexerExec extends BaseTest {
	...
	@Test
	public void testEscapeTargetStringLiteral() throws Exception {
		mkdir(tmpdir);

		StringBuilder grammarBuilder = new StringBuilder(47);
		grammarBuilder.append("lexer grammar L;\n");
		grammarBuilder.append("ACTION_WITH_DOLLAR: '$ACTION';");
		String grammar = grammarBuilder.toString();
	...
	public void testPositionAdjustingLexer() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(2484);
		grammarBuilder.append("lexer grammar PositionAdjustingLexer;\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("@definitions {\n");
		grammarBuilder.append("}\n");
		grammarBuilder.append("\n");
