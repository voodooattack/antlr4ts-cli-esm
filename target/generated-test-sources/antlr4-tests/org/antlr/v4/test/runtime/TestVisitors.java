...
public class TestVisitors extends BaseTest {
	...
	public void testCalculatorVisitor() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(1634);
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("@parser::header {\n");
		grammarBuilder.append("import { AbstractParseTreeVisitor } from \"antlr4ts/tree/AbstractParseTreeVisitor\";\n");
		grammarBuilder.append("import { RuleNode } from \"antlr4ts/tree/RuleNode\";\n");
		grammarBuilder.append("import { ErrorNode } from \"antlr4ts/tree/ErrorNode\";\n");
		grammarBuilder.append("}\n");
	...
	public void testShouldNotVisitEOF() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(765);
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("@parser::header {\n");
		grammarBuilder.append("import { AbstractParseTreeVisitor } from \"antlr4ts/tree/AbstractParseTreeVisitor\";\n");
	...
	public void testVisitErrorNode() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(770);
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("@parser::header {\n");
		grammarBuilder.append("import { AbstractParseTreeVisitor } from \"antlr4ts/tree/AbstractParseTreeVisitor\";\n");
	...
	public void testVisitTerminalNode() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(755);
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("@parser::header {\n");
		grammarBuilder.append("import { AbstractParseTreeVisitor } from \"antlr4ts/tree/AbstractParseTreeVisitor\";\n");
