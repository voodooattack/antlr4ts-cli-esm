...
public class TestListeners extends BaseTest {
	...
	public void testBasic() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(501);
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("@parser::beforeParser {\n");
		grammarBuilder.append("import { ParseTreeWalker } from \"antlr4ts/tree/ParseTreeWalker\";\n");
		grammarBuilder.append("}\n");
		grammarBuilder.append("\n");
	...
	public void testLR() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(654);
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("@parser::beforeParser {\n");
		grammarBuilder.append("import { ParseTreeWalker } from \"antlr4ts/tree/ParseTreeWalker\";\n");
	...
	public void testRuleGetters_1() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(678);
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("@parser::beforeParser {\n");
		grammarBuilder.append("import { ParseTreeWalker } from \"antlr4ts/tree/ParseTreeWalker\";\n");
	...
	public void testTokenGetters_1() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(696);
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("@parser::beforeParser {\n");
		grammarBuilder.append("import { ParseTreeWalker } from \"antlr4ts/tree/ParseTreeWalker\";\n");
